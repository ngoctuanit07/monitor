...
namespace JohnNguyen\ServerMonitor\Models;

use Carbon\Carbon;
use Symfony\Component\Process\Process;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Builder;
use JohnNguyen\ServerMonitor\Events\CheckRestored;
use JohnNguyen\ServerMonitor\Models\Enums\CheckStatus;
use JohnNguyen\ServerMonitor\Models\Concerns\HasProcess;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use JohnNguyen\ServerMonitor\CheckDefinitions\CheckDefinition;
use JohnNguyen\ServerMonitor\Models\Presenters\CheckPresenter;
use JohnNguyen\ServerMonitor\Exceptions\InvalidCheckDefinition;
use JohnNguyen\ServerMonitor\Models\Concerns\HandlesCheckResult;
use JohnNguyen\ServerMonitor\Models\Concerns\HasCustomProperties;
use JohnNguyen\ServerMonitor\Models\Concerns\ThrottlesFailingNotifications;
